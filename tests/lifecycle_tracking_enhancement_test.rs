...
fn test_enhanced_lifecycle_tracking_export() {
    ...
    assert!(
        result.is_ok(),
        "Export with enhanced lifecycle tracking should succeed"
    );
...
fn test_lifecycle_tracking_with_different_configs() {
    ...
    assert!(
        result.is_ok(),
        "Export with performance_first config should succeed"
    );
...
fn test_lifecycle_patterns_analysis() {
    ...
    assert!(
        result.is_ok(),
        "Export with lifecycle pattern analysis should succeed"
    );
