...
mod simplified_export_tests {
    ...
    fn test_memory_analysis_directory_creation() {
        ...
        assert!(
            result.is_ok(),
            "Should be able to export and create directory"
        );
        ...
        assert!(
            memory_analysis_dir.is_dir(),
            "MemoryAnalysis should be a directory"
        );
    }
}
