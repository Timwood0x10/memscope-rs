...
fn main() {
    ...
    // Test 1: Complex struct with multiple allocations
    {
        ...
        let user = UserProfile {
            ...
            tags: vec!["rust".to_string(), "developer".to_string(), "senior".to_string()],
    ...
    // Test 2: Simple struct
    {
        ...
        println!("   Created SimpleData: id={}, active={}", tracked_simple.id, tracked_simple.active);
    }
    ...
    // Test 3: Nested complex struct
    {
        ...
        println!("   Created NestedData with {} profiles", tracked_nested.profiles.len());
    ...
    // Test 5: Tuple struct
    {
        ...
        println!("   Created TupleStruct: '{}', {} numbers", tracked_tuple.0, tracked_tuple.1.len());
    }
