            ...
            |b, &size| {
                b.iter(|| {
                    ...
                    for i in 0..size {
                        ...
                        tracker
                            .track_allocation(ptr, std::mem::size_of::<i32>())
                            .unwrap();
                        tracker
                            .associate_var(ptr, format!("var_{i}"), "i32".to_string())
                            .unwrap();
    ...
    group.bench_function("hashmap_tracking", |b| {
        b.iter(|| {
            ...
            for i in 0..100 {
                ...
                tracker
                    .track_allocation(vec_ptr, value.len() * std::mem::size_of::<i32>())
                    .unwrap();
                tracker
                    .associate_var(vec_ptr, format!("vec_{i}"), "Vec<i32>".to_string())
                    .unwrap();
            ...
            tracker
                .track_allocation(map_ptr, std::mem::size_of::<HashMap<String, Vec<i32>>>())
                .unwrap();
            tracker
                .associate_var(
                    map_ptr,
...
fn benchmark_export_operations(c: &mut Criterion) {
    ...
    for i in 0..100 {
        ...
        tracker
            ...
            .unwrap();
        tracker
            .associate_var(ptr, format!("export_var_{i}"), "i32".to_string())
            .unwrap();
        unsafe {
            let _ = Box::from_raw(ptr as *mut i32);
        }
        ...
        b.iter(|| {
            ...
            for i in 0..50 {
                ...
                tracker
                    ...
                    .unwrap();
                tracker
                    .associate_var(ptr, format!("lifecycle_var_{i}"), "i32".to_string())
                    .unwrap();
        ...
        b.iter(|| {
            ...
            for i in 0..50 {
                ...
                tracker
                    .track_allocation(
                        ptr,
                        std::mem::size_of::<Vec<i32>>() + 10 * std::mem::size_of::<i32>(),
                    )
                    .unwrap();
                tracker
                    .associate_var(ptr, format!("arc_vec_{i}"), "Arc<Vec<i32>>".to_string())
                    .unwrap();
