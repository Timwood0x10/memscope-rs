...
fn benchmark_allocation_overhead(c: &mut Criterion) {
    ...
    for size in [100, 1000, 10000].iter() {
        ...
        group.bench_with_input(
            BenchmarkId::new("raw_allocation", size),
            size,
            |b, &size| {
                b.iter(|| {
        ...
        group.bench_with_input(
            BenchmarkId::new("tracked_allocation", size),
            size,
            |b, &size| {
                b.iter(|| {
...
fn benchmark_hashmap_overhead(c: &mut Criterion) {
    ...
    group.bench_function("tracked_hashmap", |b| {
        b.iter(|| {
            ...
            tracker
                .track_allocation(map_ptr, std::mem::size_of::<HashMap<String, i32>>())
                .unwrap();
            tracker
                .associate_var(
                    map_ptr,
                    "tracked_map".to_string(),
    ...
    for size in [100, 500, 1000].iter() {
        ...
        for i in 0..*size {
            ...
            tracker
                ...
                .unwrap();
            tracker
                .associate_var(ptr, format!("perf_var_{i}"), "i32".to_string())
                .unwrap();
...
fn benchmark_analysis_performance(c: &mut Criterion) {
    ...
    for i in 0..1000 {
        ...
        tracker
            ...
            .unwrap();
        tracker
            .associate_var(ptr, format!("analysis_var_{i}"), "Vec<i32>".to_string())
            .unwrap();
        ...
        if i % 4 == 0 && i > 0 {
            ...
            unsafe {
                let _ = Box::from_raw(old_ptr as *mut Vec<i32>);
            }
        }
    }
