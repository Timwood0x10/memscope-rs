...
impl VisualizationManager {
    ...
    pub fn export_memory_analysis<P: AsRef<Path>>(
        ...
        // Delegate to existing implementation to maintain output format
        crate::visualization::export_memory_analysis(tracker, path)
    }
    ...
    pub fn export_lifecycle_timeline<P: AsRef<Path>>(
        ...
        // Delegate to existing implementation to maintain output format
        crate::visualization::export_lifecycle_timeline(tracker, path)
    }
    ...
    pub fn export_unsafe_ffi_dashboard<P: AsRef<Path>>(
        ...
        // Delegate to existing implementation to maintain output format
        crate::unsafe_ffi_visualization::export_unsafe_ffi_dashboard(unsafe_tracker, path)
    }
