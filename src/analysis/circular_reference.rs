...
mod tests {
    use super::*;
    use crate::core::types::{SmartPointerInfo, SmartPointerType, RefCountSnapshot};
    ...
    fn test_analyze_cycle() {
        ...
        let smart_info_a = SmartPointerInfo {
            ...
            clones: vec![],
            cloned_from: None,
            ref_count_history: vec![RefCountSnapshot { strong_count: 1, weak_count: 0, timestamp: 0 }],
            weak_count: None,
            is_data_owner: true,
    ...
    fn test_reference_graph_creation() {
        ...
        let allocations_without_smart = vec![
            AllocationInfo {
                ptr: 0x1000,
                size: 1024,
                scope_name: None,
        ...
        let allocations_with_smart = vec![
            AllocationInfo {
                ptr: 0x1000,
                size: 1024,
                var_name: None,
    ...
    fn test_reference_graph_with_weak_references() {
        ...
        let weak_smart_info = SmartPointerInfo {
            ...
            clones: vec![],
            cloned_from: None,
            ref_count_history: vec![RefCountSnapshot { strong_count: 1, weak_count: 1, timestamp: 0 }],
            weak_count: Some(1),
            is_data_owner: false,
            is_implicitly_deallocated: false,
        };
        
        let allocations_with_weak = vec![
            AllocationInfo {
                ptr: 0x1000,
                size: 1024,
                var_name: None,
