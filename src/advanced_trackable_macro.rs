...
mod tests {
    ...
    fn test_advanced_type_info_generation() {
        let test_struct = TestGenericStruct { data: "test".to_string() };
    ...
    fn test_allocation_info_creation() {
        let test_struct = TestGenericStruct { data: RefCell::new(42) };
    ...
    fn test_generic_type_with_different_parameters() {
        ...
        let string_struct = TestGenericStruct { data: "hello".to_string() };
        let vec_struct = TestGenericStruct { data: vec![1, 2, 3] };
    ...
    fn test_allocation_info_fields() {
        let test_struct = TestGenericStruct { data: vec![1, 2, 3] };
        let advanced_info = test_struct.get_advanced_type_info().unwrap();
