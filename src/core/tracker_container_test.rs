...
mod tests {
    ...
    fn test_vec_container_analysis() {
        ...
        assert_eq!(container_analysis.reallocation_patterns.growth_pattern, GrowthPattern::Exponential);
    ...
    fn test_hashmap_container_analysis() {
        ...
        let layout = tracker.analyze_memory_layout("HashMap<String, i32>", 128).unwrap();
        ...
        assert_eq!(container_analysis.efficiency_metrics.access_efficiency, AccessEfficiency::Random);
    }
    ...
    fn test_box_container_analysis() {
        ...
        assert_eq!(container_analysis.reallocation_patterns.growth_pattern, GrowthPattern::SingleAllocation);
        assert_eq!(container_analysis.reallocation_patterns.frequency_assessment, ReallocationFrequency::None);
    }
    ...
    fn test_string_container_analysis() {
        ...
        assert_eq!(container_analysis.efficiency_metrics.access_efficiency, AccessEfficiency::Sequential);
    ...
    fn test_capacity_utilization_efficiency() {
        ...
        match small_analysis.capacity_utilization.efficiency_assessment {
            UtilizationEfficiency::Excellent | UtilizationEfficiency::Good | 
            UtilizationEfficiency::Fair | UtilizationEfficiency::Poor { .. } => {
    ...
    fn test_reallocation_pattern_detection() {
        ...
        assert!(container_analysis.reallocation_patterns.estimated_reallocations > 0);
        
        // Should have optimization suggestions
        assert!(!container_analysis.reallocation_patterns.optimization_suggestions.is_empty());
        
        // Should classify frequency appropriately
        match container_analysis.reallocation_patterns.frequency_assessment {
            ReallocationFrequency::None | ReallocationFrequency::Low | 
            ReallocationFrequency::Moderate | ReallocationFrequency::High { .. } => {
                // All variants are valid
            }
        }
    }
